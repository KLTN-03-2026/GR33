...
/**
 * Request thêm mới chứng chỉ cho sinh viên
 */
class SinhVienStoreChungChiRequest extends FormRequest
{
    ...
    {
        return [
            'ma_chung_chi'        => ['required', 'string', 'max:255', 'unique:chung_chis,ma_chung_chi'],
    ...
    {
        return [
            'ma_chung_chi.required'        => 'Mã hiệu chứng chỉ là bắt buộc.',
            'ma_chung_chi.unique'          => 'Mã hiệu chứng chỉ này đã tồn tại trên hệ thống.',
