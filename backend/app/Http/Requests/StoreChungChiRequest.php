...
class StoreChungChiRequest extends FormRequest
{
    ...
    {
        return [
            'ma_chung_chi'   => ['nullable', 'string', 'max:255', 'unique:chung_chis,ma_chung_chi'],
    ...
    public function messages(): array
    {
        return [
            ...
            'loai_chung_chi.required'=> 'Loại chứng chỉ là bắt buộc.',
