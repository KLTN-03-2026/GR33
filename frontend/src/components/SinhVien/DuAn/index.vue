            ...
            <tr v-else v-for="(item, index) in danhSachLoc" :key="item.id">
              ...
              <td class="text-end">
                <div class="d-flex justify-content-end gap-2">
                  ...
                  <button class="btn btn-action-pink" @click="moModalSua(item)" :disabled="item.is_locked">
          ...
          <div class="modal-body p-4">
            <form @submit.prevent="xuLyLuu">
              <div class="mb-3">
                ...
                <input type="text" class="form-control flux-input-lg" v-model="duLieuForm.ma_du_an" required placeholder="Ví dụ: DA-QLSV">
              </div>
              <div class="mb-3">
