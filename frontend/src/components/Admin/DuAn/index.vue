                        ...
                        <tr v-else v-for="(item, index) in danhSachPhanTrang" :key="item.id">
                            ...
                            <td class="text-end">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button v-if="item.trang_thai !== 1 && !item.is_locked && $hasPermission(46)" class="btn btn-action shadow-sm" @click="xuLyXoa(item)" title="Xóa">
                        ...
                        <form @submit.prevent="xuLyLuu">
                            <div class="row g-3">
                                <div class="col-md-6" v-if="laCapNhat">
                                    ...
                                    <input type="text" class="form-control flux-input bg-light" v-model="duLieuForm.ma_du_an"
