<template>
    <div class="nhan-vien-management">
        ...
        <div class="page-header d-flex justify-content-between align-items-center mb-4">
            ...
            <button class="btn-new" @click="moModalThemMoi">
                        ...
                        <tr v-else v-for="(item, index) in danhSachPhanTrang" :key="item.id">
                            ...
                            <td class="text-end pe-3">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button class="btn btn-action shadow-sm" @click="moModalCapNhat(item)"
                                        title="Cập nhật">
                                        <i class="bi bi-pencil-fill text-primary-darker"></i>
                                    </button>
                                    <button class="btn btn-action shadow-sm" @click="xuLyXoa(item)" title="Xóa">
